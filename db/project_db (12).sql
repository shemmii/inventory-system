...
(20, '10 liters', 15500, 0.36),
(21, '5 Gallons', 32000, 0.36),
(22, '8 liters', 32000, 0.3333);
...
(382, 6, 'OYE-GYEANG8 liters', '8 liters', '32000', 10666, '56038632.png', 'localhost/qrcode56038632.png', 'Delivered', '2023-01-31 17:40:23'),
(383, 6, 'EXD-GYEANG15500', '10 liters', '15500', 5580, '255946217.png', 'localhost/qrcode255946217.png', 'Delivered', '2023-01-31 17:40:23'),
...
--
ALTER TABLE `daily_amount`
  MODIFY `daily_amount_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=682;
...
--
ALTER TABLE `qrcodes`
  MODIFY `qr_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=385;
