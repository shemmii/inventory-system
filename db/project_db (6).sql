...
INSERT INTO `daily_amount` (`daily_amount_id`, `total_amount`, `date`) VALUES
(1, 1000, '2023-01-22 19:03:49');
...
(122, 6, 'Lisa', '  500', 50, '295581507.png', 'localhost/qrcode295581507.png', 'Delivered', '2023-01-27 17:24:58'),
(118, 6, 'Jennie kim', '  500', 50, '1129197837.png', 'localhost/qrcode1129197837.png', 'Delivered', '2023-01-26 17:12:05'),
(117, 6, 'shem', '  500', 70, '724251016.png', 'localhost/qrcode724251016.png', 'Delivered', '2023-01-30 17:11:03'),
...
(94, 6, 'Lisa', '  500', 50, '504037062.png', 'localhost/qrcode504037062.png', 'Delivered', '2023-01-28 16:30:16'),
...
--
ALTER TABLE `daily_amount`
  MODIFY `daily_amount_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
