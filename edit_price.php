...
$price_id = $_GET['id'];
//selecting
$query = $pdo->prepare("SELECT * FROM price_list WHERE price_id = '$price_id' ");
$query->execute();
...
<td><input class="input" type="text" name="volume" value="<?php echo   $volume;?> " /><br></td>
<td><input class="input" type="text" name="value" value="<?php echo   $value;?> " /><br></td>

<td><input class="input" type="text" name="container_price" value="<?php echo   $container_price;?> " /><br></td>
